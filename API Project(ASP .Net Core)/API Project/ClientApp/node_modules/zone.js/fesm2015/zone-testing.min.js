"use strict";var __spreadArray=this&&this.__spreadArray||function(e,t,n){if(n||2===arguments.length)for(var r,i=0,s=t.length;i<s;i++)!r&&i in t||(r||(r=Array.prototype.slice.call(t,0,i)),r[i]=t[i]);return e.concat(r||Array.prototype.slice.call(t))};
/**
...
/**
     ...
     */
var e={},t="__creationTrace__",n="STACKTRACE TRACKING",r="__SEP_TAG__",i=r+"@[native]",s=function s(){this.error=l(),this.timestamp=new Date};function o(){return new Error(n)}function a(){try{throw o()}catch(e){return e}}var c=o(),u=a(),l=c.stack?o:u.stack?a:o;function h(e){return e.stack?e.stack.split("\n"):[]}function p(t,n){for(var r=h(n),i=0;i<r.length;i++)e.hasOwnProperty(r[i])||t.push(r[i])}function f(e,t){var n=[t?t.trim():""];if(e)for(var s=(new Date).getTime(),o=0;o<e.length;o++){var a=e[o],c=a.timestamp,u="____________________Elapsed ".concat(s-c.getTime()," ms; At: ").concat(c);u=u.replace(/[^\w\d]/g,"_"),n.push(i.replace(r,u)),p(n,a.error),s=c.getTime()}return n.join("\n")}function d(){return Error.stackTraceLimit>0}function y(e,t){t>0&&(e.push(h((new s).error)),y(e,t-1))}Zone.longStackTraceZoneSpec={name:"long-stack-trace",longStackTraceLimit:10,getLongStackTrace:function(e){if(e){var t=e[Zone.__symbol__("currentTaskTrace")];return t?f(t,e.stack):e.stack}},onScheduleTask:function(e,n,r,i){if(d()){var o=Zone.currentTask,a=o&&o.data&&o.data[t]||[];(a=[new s].concat(a)).length>this.longStackTraceLimit&&(a.length=this.longStackTraceLimit),i.data||(i.data={}),"eventTask"===i.type&&(i.data=Object.assign({},i.data)),i.data[t]=a}return e.scheduleTask(r,i)},onHandleError:function(e,n,r,i){if(d()){var s=Zone.currentTask||i.task;if(i instanceof Error&&s){var o=f(s.data&&s.data[t],i.stack);try{i.stack=i.longStack=o}catch(e){}}}return e.handleError(r,i)}},function m(){if(d()){var t=[];y(t,2);for(var s=t[0],o=t[1],a=0;a<s.length;a++)if(-1==(u=s[a]).indexOf(n)){var c=u.match(/^\s*at\s+/);if(c){i=c[0]+r+" (http://localhost)";break}}for(a=0;a<s.length;a++){var u;if((u=s[a])!==o[a])break;e[u]=!0}}}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var _,k,g=function(){function e(e){this.runZone=Zone.current,this.name="syncTestZone for "+e}return e.prototype.onScheduleTask=function(e,t,n,r){switch(r.type){case"microTask":case"macroTask":throw new Error("Cannot call ".concat(r.source," from within a sync test (").concat(this.name,")."));case"eventTask":r=e.scheduleTask(n,r)}return r},e}();Zone.SyncTestZoneSpec=g,
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
Zone.__load_patch("mocha",(function(e,t){var n=e.Mocha;if(void 0!==n){if(void 0===t)throw new Error("Missing Zone.js");var r=t.ProxyZoneSpec,i=t.SyncTestZoneSpec;if(!r)throw new Error("Missing ProxyZoneSpec");if(n.__zone_patch__)throw new Error('"Mocha" has already been patched with "Zone".');n.__zone_patch__=!0;var s,o,a=t.current,c=a.fork(new i("Mocha.describe")),u=null,l=a.fork(new r),h={after:e.after,afterEach:e.afterEach,before:e.before,beforeEach:e.beforeEach,describe:e.describe,it:e.it};e.describe=e.suite=function(){return h.describe.apply(this,f(arguments))},e.xdescribe=e.suite.skip=function(){return h.describe.skip.apply(this,f(arguments))},e.describe.only=e.suite.only=function(){return h.describe.only.apply(this,f(arguments))},e.it=e.specify=e.test=function(){return h.it.apply(this,d(arguments))},e.xit=e.xspecify=function(){return h.it.skip.apply(this,d(arguments))},e.it.only=e.test.only=function(){return h.it.only.apply(this,d(arguments))},e.after=e.suiteTeardown=function(){return h.after.apply(this,y(arguments))},e.afterEach=e.teardown=function(){return h.afterEach.apply(this,d(arguments))},e.before=e.suiteSetup=function(){return h.before.apply(this,y(arguments))},e.beforeEach=e.setup=function(){return h.beforeEach.apply(this,d(arguments))},s=n.Runner.prototype.runTest,o=n.Runner.prototype.run,n.Runner.prototype.runTest=function(e){var n=this;t.current.scheduleMicroTask("mocha.forceTask",(function(){s.call(n,e)}))},n.Runner.prototype.run=function(e){return this.on("test",(function(e){u=a.fork(new r)})),this.on("fail",(function(e,t){var n=u&&u.get("ProxyZoneSpec");if(n&&t)try{t.message+=n.getAndClearPendingTasksInfo()}catch(e){}})),o.call(this,e)}}function p(e,t,n){for(var r=function(r){var i=e[r];"function"==typeof i&&(e[r]=0===i.length?t(i):n(i),e[r].toString=function(){return i.toString()})},i=0;i<e.length;i++)r(i);return e}function f(e){return p(e,(function(e){return function(){return c.run(e,this,arguments)}}))}function d(e){return p(e,(function(e){return function(){return u.run(e,this)}}),(function(e){return function(t){return u.run(e,this,[t])}}))}function y(e){return p(e,(function(e){return function(){return l.run(e,this)}}),(function(e){return function(t){return l.run(e,this,[t])}}))}})),
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *

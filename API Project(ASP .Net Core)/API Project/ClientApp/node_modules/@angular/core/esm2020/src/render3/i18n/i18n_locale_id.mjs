n combineLatest<O1 extends ObservableInput<any>>(sources: [O1]): Observable<[ObservedValueOf<O1>]>;
...
/** @deprecated Pass arguments in a single array instead `combineLatest([a, 